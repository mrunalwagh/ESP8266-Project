...
const char* ssid = "hac"; //--> Your wifi name or SSID.
const char* password = "hac123456"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbwojuQSO0VUbvFJVYXEfX0FbdWaxo2CY5rXRBlzjAAwbFj3sfJ7tJC4rvwLtm6zsZ1U"; //--> spreadsheet script ID
