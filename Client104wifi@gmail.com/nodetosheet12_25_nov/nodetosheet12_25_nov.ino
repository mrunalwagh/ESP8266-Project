...
const char* ssid = "hac";                //replace with our wifi ssid
const char* password = "hac123456";         //replace with your wifi password


const char* host = "script.google.com";
const char *GScriptId = "1R-C2EAq2Feheog76ahV4eUkiaVW3psTxm5K8SVMu9IMJGISUnIsgw13"; // Replaced with kmsanghvigrapes mail sheet  temp4 sheet id 
...
// payload = payload_base + "\" + sheetTemp + "," + sheetRange+ "," + sheetTimeStamp + "\"}";             //========================================change
